        ...
        <section className="mt-5">
            <div className="container px-4 mx-auto">
                <div
                    ...
                    <div
                        className="col-span-12 md:col-span-6 lg:col-span-8 xl:col-span-9 relative after:bg-[var(--border-color)] dark:after:bg-[var(--border-dark)] after:absolute after:w-full after:h-0 md:after:w-[1px] md:after:h-full after:right-0 after:-bottom-3 md:after:top-0 md:after:-right-3">
                        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                            <div
                                className="col-span-12 relative after:bg-[var(--border-color)] after:absolute after:w-full after:h-[1px] last:after:h-0 after:-bottom-3 dark:after:bg-[var(--border-dark)]">
                                    ...
                                    {data?.slice(4, 6)?.map((itm, i) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                >
                                                    <div
                                                        className="ml-3 mb-1 md:mb-0 overflow-hidden float-right relative">
                                                        <div>
                                                            <Image
                                                                alt={post_title}
                                                                width={330}
