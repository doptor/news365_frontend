        ...
        <section className="mt-[60px] NewsWithLatestTwo">
            <div className="container px-4 mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                    <div
                        className="col-span-12 lg:col-span-8 relative after:bg-[var(--border-color)] after:absolute after:w-full after:h-[1px] after:right-0 after:left-0 after:-bottom-3 dark:after:bg-[var(--border-dark)] mb-4 md:mb-0">
                        <div
                        ...
                        <div
                            className="relative after:bg-[var(--border-color)] after:absolute after:w-full after:h-[1px] after:-bottom-3 dark:after:bg-[var(--border-dark)]">
                        ...
                        <div
                            className="flex flex-col md:flex-row gap-6 relative after:bg-[var(--border-color)] after:absolute after:w-full after:h-[1px] after:-bottom-3 dark:after:bg-[var(--border-dark)]">
                            {post?.slice(1, 4)?.map((item, i) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        >
                                            <div
                                                className="overflow-hidden relative ml-2 md:ml-0 mb-2 float-right md:float-none">
                                                <div>
                                                    <Image
                                                        alt={post_title}
                                                        width={330}
                    ...
                    <div
                        className="col-span-12 lg:col-span-4 relative after:bg-[var(--border-color)] after:absolute after:w-full after:h-[1px] after:right-0 after:left-0 after:-bottom-3 dark:after:bg-[var(--border-dark)]">
