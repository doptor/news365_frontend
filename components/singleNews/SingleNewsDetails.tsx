        ...
        <div className={clss}>
            ...
            <div className="container px-4 mx-auto print:px-0">
                    ...
                    <div
                        ...
                        <article ref={printRef}>
                            <div className="mb-3">
                                ...
                                <div
                                    className="flex flex-col md:flex-row gap-3 items-center justify-between relative after:bg-[var(--border-color)] after:absolute after:w-full after:h-[1px] after:right-0 after:-top-3 dark:after:bg-[var(--border-dark)] print:after:bg-transparent">
                                    <div className="w-full md:w-1/2">
                                        <div
                                            className="flex flex-row gap-2 items-center text-[var(--dark)] text-sm dark:text-white print:dark:text-[var(--dark)]">
                                            <Image
                                                alt={title}
                                                loading="lazy"
                                                width={192}
                                            ...
                                            <div className="flex flex-col">
                                                <div><span>{reporter}</span><span className="ml-1">|</span><span
                                                    className="ml-1">{is_on_print_media === 1 ? "প্রিন্ট সংস্করণ" : "অনলাইন সংস্করণ"}</span>
                                                </div>
                            ...
                            <div className="container mt-5 comment-section" style={{ display: "none" }}>
                                                ...
                                                {comments.map((comment: Comment, index) => (
                                                    <li key={index} className="comment">
                                                        <div className="comment-header">
                                                            <span
                                                                className="comment-author">{comment.com_username}</span>
                                ...
                                <div className="comment-form-container">
                                    ...
                                    <form onSubmit={handleCommentSubmit} className="comment-form">
                                        ...
                                        {commentSuccessText &&
                                            <div className="message message-success">{commentSuccessText}</div>}
                                        {commentErrorText &&
                                            <div className="message message-danger">{commentErrorText}</div>}
                        ...
                        <div className="container mx-auto print:hidden">
                            <div
                                className="relative mt-6 mb-6 before:absolute before:bg-[var(--border-color)] before:w-full before:h-[1px] before:left-0 before:-top-3 after:bg-[var(--border-color)] after:absolute after:w-full after:h-[1px] after:left-0 after:-bottom-2 print:hidden dark:before:bg-[var(--border-color)] dark:after:bg-[var(--border-dark)]">
                            ...
                            <div
                                className="grid grid-cols-1 md:grid-cols-12 gap-6 md:after:[&>*:nth-last-child(-n+2)]:h-0 lg:after:[&>*:nth-last-child(-n+2)]:h-full lg:after:[&>*:nth-child(3)]:w-0 lg:after:[&>*]:w-[1px] after:[&>*:last-child]:w-0 after:[&>*]:h-[1px] lg:after:[&>*]:h-full print:hidden dark:after:[&>*]:bg-[var(--border-color)]">
                ...
                <AddCard imgPath={data.ads.news_view_31} />
                            ...
                            <div className="mb-3">
                                <div
                                    className="mt-3 mb-3 border-[var(--border-color)] border-t-[1px] border-b-[1px] dark:border-[var(--border-dark)]">
                                ...
                                <div className="last:[&>*]:mb-0 after:last:[&>*]:h-0">
                                        ...
                                        return (
                                            ...
                                            >
                                                <div className="flex mb-6">
                                                    <div
                                                        className="mb-6 last:mb-0 relative after:bg-[var(--border-color)] after:absolute after:w-full after:h-[1px] after:-bottom-3 after:last:h-0 dark:after:bg-[var(--border-dark)] w-full">
                                                        <Link
                                                            className="group"
                                                            href={`/${category.toLocaleLowerCase()}/${encode_titl}`}
                                                        >
                                                            <div
                                                                className="md:hidden ml-2 md:ml-0 lg:ml-2 mb-2 overflow-hidden float-right relative">
                                                                <div>
                                                                    <Image
                                                                        alt={image_alt}
                                                                        width={330}
                                    ...
                                    <div
                                        className="mb-6 relative after:bg-[var(--border-color)] after:absolute after:w-full after:h-[1px] after:-bottom-3 after:right-0 dark:after:bg-[var(--border-dark)] before:h-px before:-top-3 before:bg-[var(--border-color)] dark:before:bg-[var(--border-color)] before:absolute before:w-full">
