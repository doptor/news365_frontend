...
const Socials = ({
    ...
    return (
        ...
        target="_blank"
      >
        <div className="w-8 h-8 border-[1px] border-black/30 dark:border-white flex justify-center items-center rounded-full group-hover:border-black duration-500 ease-out">
          <WhatsAppIcon />
        </div>
      </Link> */}
            {tw &&
